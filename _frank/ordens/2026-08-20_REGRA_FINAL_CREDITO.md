...
## O que isso quer dizer, sem interpretação

| situação | créditos | acesso |
|---|---|---|
| pagando em dia | recebe a recarga do ciclo | tem |
| **parou de pagar** | **não recebe recarga nova** | **usa o saldo que tem, até acabar** |
| nunca pagou (só trial R$0) | não recebe | — |

**O saldo não zera. O saldo não fica parado. A pessoa gasta o que comprou até
o fim.** O que para é a **entrada** de crédito novo, não a saída.

## Esta ordem substitui e encerra

- `2026-08-18_cancelar_credito_no_vencimento.md` (venceu → zera) — **morta**
- `2026-08-18_regra_final_pagou_fica.md` — absorvida; a redação acima vale
- `2026-08-20_decisoes_55_trancadas_e_turno_noite.md` **item 1** — encerrado
- as 4 ressalvas do Frank de 14:43 — **resolvidas pela própria regra**:
  não existe "volta a ser usável" para implementar (ela nunca perde o uso);
  não precisa definir dias de tolerância para acesso; não há saldo estacionando.
...
Só volta ao assunto se **o Johnny** levantar.
