...
/**
 * Árvore de navegação do app — FONTE ÚNICA (02/09).
 *
 * Antes esta lista vivia inline dentro do <aside> do sidebar.tsx, que é
 * `hidden lg:flex`: no celular o aluno ficava sem NENHUM menu (incidente #220,
 * 434 alunos entraram por celular). Agora o mesmo componente é renderizado nos
 * dois lugares — o <aside> do desktop e o drawer mobile.
 *
 * REGRA: nunca duplicar esta lista. Item novo entra aqui e aparece nos dois.
 */
