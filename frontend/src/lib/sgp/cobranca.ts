 ...
 */
export const COLUNAS_CONCLUSAO_AUTO = ["concluido_automatico"] as const;
...
export function colunaConclusaoAutomaticaAusente(error: unknown): boolean {
  return colunaAusente(error, COLUNAS_CONCLUSAO_AUTO);
}
