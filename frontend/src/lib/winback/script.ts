...
export function openingInstruction(t: WinbackTargetRow, nome: string | null): string {
  ...
  return [
    ...
    "- ESCREVA COMO GENTE ESCREVE NO WHATSAPP: em 2 ou 3 mensagens curtinhas,",
    "  não num parágrafo só. Separe cada mensagem com uma LINHA EM BRANCO — o",
    "  sistema manda uma de cada vez, com 'digitando…' no meio, como se você",
    "  estivesse escrevendo na hora. Exemplo do ritmo:",
    "     Oi, tudo bem?",
    "     (linha em branco)",
    "     Aqui é a Carol, do FastCloner 🧡",
    "     (linha em branco)",
    "     Vi que você cancelou e queria entender o que aconteceu — foi o preço,",
