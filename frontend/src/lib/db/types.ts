...
export type AdminEmailRow = {
  id: string;
  email: string;
  /** mig 95 — admin = painel inteiro · suporte = só Falhas + SGP + Agente. */
  role: "admin" | "suporte";
...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      zero_subscription_credits_on_refund: {
        Args: { p_user_id: string; p_ref_id: string; p_event_type?: string | null };
        Returns: Json;
      };
